...
![Create Steel](/images/Datasets/Example%20generate%20data.PNG)
...
![Assign objects to dataset](/images/Datasets/AssignObejctsToDataset.PNG)

3. Populate the source object and assign it to the dataset. See guidance [below](#Source) regarding the source.

![Assign source](/images/Datasets/AssignSourceToDataset.PNG)
...
![Store json to file](/images/Datasets/SaveDatasetToFile.PNG)
...
![Add user path](/images/Datasets/AddUserPath.PNG)
...
![Remove user path](/images/Datasets/RemoveUserPath.PNG)
