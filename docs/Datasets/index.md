...
![Create Steel](/_images/Datasets/Example%20generate%20data.PNG)
...
![Assign objects to dataset](/_images/Datasets/AssignObejctsToDataset.PNG)

3. Populate the source object and assign it to the dataset. See guidance [below](#Source) regarding the source.

![Assign source](/_images/Datasets/AssignSourceToDataset.PNG)
...
![Store json to file](/_images/Datasets/SaveDatasetToFile.PNG)
...
![Add user path](/_images/Datasets/AddUserPath.PNG)
...
![Remove user path](/_images/Datasets/RemoveUserPath.PNG)
