...
> ### Note
> This page can be seen as an Appendix to the pages [Introduction to BHoM_Adapter](https://github.com/BHoM/documentation/wiki/Introduction-to-the-BHoM_Adapter) and [Adapter Actions](https://github.com/BHoM/documentation/wiki/Adapter-Actions).

The Adapter Actions have some particular input parameters that have not been covered in the [introduction to the BHoM_Adapter](https://github.com/BHoM/documentation/wiki/Introduction-to-the-BHoM_Adapter). These are:
...
This means that it can contain configurations that are specific to certain Actions (e.g. only to the Push, only to the Pull), and that a certain Push might be activated with a different Push ActionConfig than another one. This makes the ActionConfig different from the [Adapter Settings](https://github.com/BHoM/documentation/wiki/The-BHoM-Toolkit#the-adapter-settings) (which are `static` global settings).
...
For an in depth explanation on how tags are used and what you should be implementing for them to work, read the Push section of our [Adapter Actions](https://github.com/BHoM/documentation/wiki/Adapter-Actions) page; in particular, look at the [practical example](https://github.com/BHoM/documentation/wiki/Adapter-Actions#a-practical-example).  
