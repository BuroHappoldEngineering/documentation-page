...
![Assign objects to dataset](https://github.com/BHoM/documentation/blob/main/wiki/images/Datasets/AssignObejctsToDataset.PNG)

3. Populate the source object and assign it to the dataset. See guidance [below](#Source) regarding the source.

![Assign source](https://github.com/BHoM/documentation/blob/main/wiki/images/Datasets/AssignSourceToDataset.PNG)
...
![Store json to file](https://github.com/BHoM/documentation/blob/main/wiki/images/Datasets/SaveDatasetToFile.PNG)
...
![Add user path](https://github.com/BHoM/documentation/blob/main/wiki/images/Datasets/AddUserPath.PNG)
...
![Remove user path](https://github.com/BHoM/documentation/blob/main/wiki/images/Datasets/RemoveUserPath.PNG)
...
Compliance regulations for Datasets are outlined in https://github.com/BHoM/documentation/wiki/IsValidDataset
