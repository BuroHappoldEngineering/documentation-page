...
🤖 **Developers**: check out also the [Diffing and Hash: Guide for developers](https://github.com/BHoM/documentation/wiki/Diffing-and-Hashing:-guide-for-developers).
...
- **`ComparisonConfig`** allows you to specify all the object comparison options; **see [its dedicated page](https://github.com/BHoM/documentation/wiki/Configuring-objects-comparison:-%60ComparisonConfig%60)**.
...
Other than these, _Toolkit-specific_ diffing methods exist to deal with the subtleties of comparing Objects defined in a Toolkit. Users do not generally need to know about these, as [Toolkit-specific diffing methods will be automatically called for you if needed by the generic IDiffing method](https://github.com/BHoM/documentation/wiki/Diffing-and-Hashing%3A-guide-for-developers#invoking-of-the-toolkit-specific-diffing-methods). Just for reference, a Toolkit-specific Diffing method is [`RevitDiffing()`](https://github.com/BHoM/Revit_Toolkit/blob/main/Revit_Engine/Compute/RevitDiffing.cs).
...
The [`DiffWithHash()`](https://github.com/BHoM/BHoM_Engine/blob/main/Diffing_Engine/Compute/DiffWithHash.cs) method simply does a Venn Diagram of the input objects' [Hashes](https://github.com/BHoM/documentation/wiki/Hash:-an-object's-identity):

![image](https://user-images.githubusercontent.com/6352844/146240551-33b43deb-6ac2-4c48-aef6-07bd172c25d2.png)

The Venn Diagram is computed by means of a [`HashComparer`](https://github.com/BHoM/BHoM_Engine/blob/6cf19b04a34803fcdc904bdfaaab3245f5869514/BHoM_Engine/Objects/EqualityComparers/HashComparer.cs#L39), which simply means that the [Hash](https://github.com/BHoM/documentation/wiki/Hash:-an-object's-identity) of all input objects gets computed.  
...
The Hash is leveraged by this method so you are able to customise how the diffing behaves by specifying a [`ComparisonConfig` options](https://github.com/BHoM/documentation/wiki/Configuring-objects-comparison:-%60ComparisonConfig%60) in the `DiffingConfig`.
